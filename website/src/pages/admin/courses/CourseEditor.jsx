...
export default function CourseEditor() {
    ...
    const handleEditQuestion = async () => {
      ...
      try {
        ...
        await fetch(
          `http://localhost:3000/quizQuestions/${editQuestionForm.question_id}`,
          {
            method: "PUT",
    ...
    try {
        ...
        await fetch(
        `http://localhost:3000/quizzes/${editingQuiz.quiz_id}`,
        {
            method: "PUT",
    ...
    try {
        ...
        await fetch(
        `http://localhost:3000/modules/${editingModule.module_id}`,
        {
            method: "PUT",
...
async (e) => {
  ...
  try {
    ...
    const res = await fetch(
      "http://localhost:3000/uploads-api/course-image",
      {
        method: "POST",
...
<div className="form-group">
  ...
  {courseForm.image_url && (
    ...
    <img
      ...
      src={
        `http://localhost:3000${courseForm.image_url}`
      }
