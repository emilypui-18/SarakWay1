  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(
        "http://10.244.107.80:3000/register",
        {
          method: "POST",
    ...
    <div className="auth-page register">
      ...
      <div className="scene" aria-hidden="true">
        ...
        >
          ...
          <path
            d="M0 540 C 180 460, 360 520, 540 480 S 880 420, 1060 480 S 1380 520, 1600 480 L 1600 900 L 0 900 Z"
            fill="url(#hill-far-r)"
          />

          <path
            d="M0 660 C 220 600, 420 670, 620 630 S 980 580, 1180 640 S 1440 660, 1600 620 L 1600 900 L 0 900 Z"
            fill="url(#hill-mid-r)"
          />

          <path
            d="M0 780 C 120 760, 220 800, 320 780 C 400 765, 440 740, 510 760 C 580 780, 640 750, 720 770 C 820 795, 880 745, 980 770 C 1060 790, 1140 760, 1240 775 C 1340 790, 1440 760, 1600 780 L 1600 900 L 0 900 Z"
            fill="url(#hill-near-r)"
          />
      ...
      <main className="auth">
        ...
        <section className="intro">
          ...
          <p className="lead reveal">
            Create your SarakWay account to access
            flexible training modules,
            live IoT alerts,
            and SFC-endorsed certifications.
          </p>
        ...
        <section className="card reveal">
          ...
          <form onSubmit={handleSubmit} autoComplete="on">
            ...
            <label className="terms">
              ...
              <span>
                I agree to SarakWay's terms and policies.
              </span>
